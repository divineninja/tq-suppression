		...
		<tbody>
			<?php foreach ($this->files as $key => $value) { ?>
				<tr>
					...
					<td>
						<a class="delete-item" href="<?php echo $this->set_url("inclusion/deleteUploadFile/{$value->id}"); ?>">Delete</a>
					</td>
				</tr>
			<?php } ?>		
		</tbody>
...
<div class="col-lg-12">
	<form method="POST" class="inclusion_upload" action="<?php echo $this->set_url('inclusion/saveSupression'); ?>" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="file" class="form-control" name="inclusion_file" required="required" accept=".txt" />
		</div>
			<button class="btn-small btn btn-default">Save</button>
			<!-- <a href="<?php echo $this->set_url('inclusion/truncate'); ?>" class="btn-small btn btn-default btn-danger">Delete All Content</a> -->
	</form>
</div>