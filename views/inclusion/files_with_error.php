<table class="table">
	...
	<?php foreach($this->items_with_error as  $files) { 
		...
		$display_link = str_replace('/var/www/uploads/inclusion/', '', $files->file_name);
	...
	?>
		<tr>
			...
			<td>
				...
				<a href="<?php echo $this->set_url("inclusion/errorFiles/$file_value"); ?>" ><button class="btn btn-xs btn-small btn-warning">Phone Numbers</button></a>
...
<?php
	if( isset($this->phone_with_error)) {
		?>
		<h3><?php echo str_replace('/var/www/uploads/inclusion/', '', $this->file_name); ?></h3>
		<table class="table">
			<thead>
				<th>#</th>
				<th>Phone</th>
