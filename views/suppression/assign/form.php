<div class="col-lg-12">
	<form method="POST" class="supression_upload" action="<?php echo $this->set_url('suppression/question_suppression'); ?>">
	<div class="col-lg-3">
	...
	<div class="col-lg-6">
		<div class="form-group">
			...
			<select name="suppression[]" class="form-control" multiple="multiple" required="required" style="height:200px">
				<option value="" disabled="disabled"> -- SELECT -- </option>
				<?php foreach ($this->suppression_file as $key => $value) { ?>
